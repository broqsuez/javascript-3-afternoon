...
//Code Here
let postTaxPrices = prices.map(function(val){return val * 1.07});
...
//Code Here
let myStrongest = monstersInYourPocket.filter(function(object){return object.CP > 200});
...
let ordersTotal = orders.map((object) => object.price * orders.tax);
